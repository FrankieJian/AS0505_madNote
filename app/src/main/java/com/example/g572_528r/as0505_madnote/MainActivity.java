package com.example.g572_528r.as0505_madnote;
                ...
                new TimePickerDialog(MainActivity.this, 0,
                        new TimePickerDialog.OnTimeSetListener() {
                            ...
                            public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                                ...
                                // 鏍规嵁鐢ㄦ埛閫夋嫨鐨勬椂闂存潵璁剧疆Calendar瀵硅薄
                                c.set(Calendar.HOUR, hourOfDay);
                                c.set(Calendar.MINUTE, minute);
                                // 鈶¤缃瓵larmManager鍦–alendar瀵瑰簲鐨勬椂闂村惎鍔ˋctivity
                                alarmManager.set(AlarmManager.RTC_WAKEUP, c.getTimeInMillis(), pi);
                                Log.e("HEHE", c.getTimeInMillis() + "");   //杩欓噷鐨勬椂闂存槸涓€涓猽nix鏃堕棿鎴?                                // 鎻愮ず闂归挓璁剧疆瀹屾瘯:
                                Toast.makeText(MainActivity.this, "闂归挓璁剧疆瀹屾瘯~" + c.getTimeInMillis(),
